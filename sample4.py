...
# Summarize the extracted content using the 'pipeline' from Hugging Face Transformers
summarizer = pipeline("summarization")
output_hf = summarizer(relevant_content, min_length=40, length_penalty=2.0, num_beams=4, early_stopping=True)

# Print or use the Hugging Face 'pipeline' summary as needed
print("Hugging Face 'pipeline' Summary:")
print(output_hf[0]["summary_text"])

# Use the BERT summarizer
bert_model = Summarizer()
bert_summary = ''.join(bert_model(relevant_content, min_length=10))

# # Print or use the BERT summary as needed
# print("BERT Summary:")
# print(bert_summary)

# # Use the GPT-2 summarizer
# gpt2_model = TransformerSummarizer(transformer_type="GPT2", transformer_model_key="gpt2-medium")
# gpt2_summary = ''.join(gpt2_model(relevant_content, min_length=10))

# # Print or use the GPT-2 summary as needed
# print("GPT-2 Summary:")
# print(gpt2_summary)
