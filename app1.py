...
def index():
    if request.method == "POST":
        ...
        if uploaded_file and keyword:
            ...
            spacy_summary = " ".join(sent.text for sent in doc.sents)

            return render_template("index1.html", keyword=keyword, extracted_content=relevant_content, hf_summary=summary_hf, summarizer_summary=summarizer_summary, spacy_summary=spacy_summary)

    return render_template("index1.html", keyword="", extracted_content="", hf_summary="", summarizer_summary="")
